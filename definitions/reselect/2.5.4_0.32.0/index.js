...
export function createStructuredSelector <S : stateType, P: propsType, SO: selectorsObject<S, P, *, *>>(selectors: SO, selectorCreator : selectorCreatorFunc<*,*,S,P,*,*> = createSelector) : selectorFunc<S, P, {[key: $Keys<SO>]: *}> {
  const objectKeys = Object.keys(selectors)
  return selectorCreator(
    objectKeys.map( (key) => selectors[key]),
    (...values: Array<*>) => {
      return values.reduce((composition, value, index) : {[key: $Keys<SO>]: *}  => {
